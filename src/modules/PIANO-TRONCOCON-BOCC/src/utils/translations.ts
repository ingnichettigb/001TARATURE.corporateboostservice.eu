...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "PIANO-TRONCOCON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo troncoconico e coperchio piano raccordato. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
  ...
  en: {
    appName: "PIANO-TRONCOCON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with truncated-cone bottom and flat, knuckled top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con fondo troncocónico y tapa plana con empalme. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für zylindrische Tanks mit Kegelstumpfboden und flachem Deckel mit Krempe. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    active: "AKTIV",
