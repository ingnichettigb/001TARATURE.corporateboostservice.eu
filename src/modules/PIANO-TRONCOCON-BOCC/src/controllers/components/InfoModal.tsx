...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici verticali dotati di fondo troncoconico (cono con base minore piana, di diametro d_min) e coperchio piano raccordato (disco di lamiera con raccordo toroidale r). Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Il Modello Matematico a 7 Zone",
          desc: "Il serbatoio viene scomposto geometricamente in 7 zone d'integrazione continue per gestire con assoluto rigore matematico la variazione di raggio dovuta alla conicità del fondo e alla raccordatura delle due testate:",
          items: [
            "**Zona 1 (Tronco di cono del fondo)**: Dal fondo piano di diametro d_min (base minore) fino all'inizio del raccordo; il raggio cresce linearmente da d_min/2 a Y. Con d_min = 0 il cono termina a punta.",
            "**Zona 7 (Disco piano del coperchio)**: Il disco piano vero e proprio, di raggio X = R − r; non aggiunge altezza oltre al raccordo (Zona 6). Se il raccordo r = 0, il coperchio è un disco piano puro.",
            "**Zona 2 (Raccordo cono/colletto, Fondo)**: Arco tangente di raggio r che unisce la superficie del tronco di cono al colletto cilindrico.",
            "**Zona 6 (Raccordo colletto/disco, Coperchio)**: Quarto di toro di raggio r che unisce il colletto cilindrico al disco piano centrale.",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step calibration for vertical cylindrical tanks with a truncated-cone bottom (a cone with a flat minor base of diameter d_min) and a knuckled flat top (a flat disc with a toroidal knuckle radius r). Calculations are computed continuously with 1 mm step resolution.",
      
      sections: [
        {
          icon: Layers,
          title: "1. The 7-Zone Mathematical Model",
          desc: "The tank volume is dynamically divided into 7 distinct geometric integration zones to strictly solve for the varying radii of the conical bottom and the knuckle joints of both heads:",
          items: [
            "**Zone 1 (Bottom truncated cone)**: From the flat bottom of diameter d_min (minor base) up to the start of the knuckle; the radius grows linearly from d_min/2 to Y. With d_min = 0 the cone ends in a point.",
            "**Zone 7 (Top flat disc)**: The flat disc itself, of radius X = R − r; it adds no height beyond the knuckle (Zone 6). With r = 0 the top head is a pure flat disc.",
            "**Zone 2 (Cone/flange knuckle, Bottom)**: Tangent arc of radius r joining the truncated-cone surface to the straight flange.",
            "**Zone 6 (Flange/disc knuckle, Top)**: Quarter-torus arc of radius r joining the straight flange to the central flat disc.",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza el cálculo geométrico milimétrico de tanques cilíndricos verticales con fondo troncocónico (cono con base menor plana, de diámetro d_min) y tapa plana con empalme (disco de chapa con radio de acuerdo toroidal r). La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            "**Zona 1 (Tronco de cono del fondo)**: Desde el fondo plano de diámetro d_min (base menor) hasta el inicio del empalme; el radio crece linealmente de d_min/2 a Y. Con d_min = 0 el cono termina en punta.",
            "**Zona 7 (Disco plano de la tapa)**: El disco plano propiamente dicho, de radio X = R − r; no añade altura más allá del empalme (Zona 6). Con r = 0 la tapa es un disco plano puro.",
            "**Zona 2 (Empalme cono/collarín, Fondo)**: Arco tangente de radio r que une la superficie del tronco de cono al collarín cilíndrico.",
            "**Zona 6 (Empalme collarín/disco, Tapa)**: Arco de cuarto de toro de radio r que une el collarín cilíndrico al disco plano central.",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Inhaltsberechnung für stehende zylindrische Behälter mit Kegelstumpfboden (Kegel mit ebener kleiner Grundfläche vom Durchmesser d_min) und flachem Deckel mit Krempe (ebene Scheibe mit toroidalem Krempenradius r). Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      ...
      sections: [
        {
          ...
          items: [
            "**Zone 1 (Kegelstumpf des Bodens)**: Vom ebenen Boden mit Durchmesser d_min (kleine Grundfläche) bis zum Beginn der Krempe; der Radius wächst linear von d_min/2 auf Y. Bei d_min = 0 läuft der Kegel spitz zu.",
            "**Zone 7 (Flache Scheibe des Deckels)**: Die eigentliche ebene Scheibe mit Radius X = R − r; sie fügt über die Krempe (Zone 6) hinaus keine Höhe hinzu. Bei r = 0 ist der Deckel eine reine ebene Scheibe.",
            "**Zone 2 (Krempe Konus/Bord, Boden)**: Tangentialer Übergangsbogen mit Radius r, der die Kegelstumpffläche mit der zylindrischen Zarge verbindet.",
            "**Zone 6 (Krempe Bord/Scheibe, Deckel)**: Viertelkreisbogen (Torus) mit Radius r, der die zylindrische Zarge mit der zentralen ebenen Scheibe verbindet.",
