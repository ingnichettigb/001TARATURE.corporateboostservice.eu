...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "ORIZZ-BOMB TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici ORIZZONTALI con fondo bombato e coperchio bombato standard o custom. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
  ...
  en: {
    appName: "ORIZZ-BOMB TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for HORIZONTAL cylindrical tanks with standard or custom dished bottom and dished top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
    ...
    lCil: "Cylindrical Part Length (L_cil)",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos HORIZONTALES con fondo bombeado estándar o personalizado y tapa bombada. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
    ...
    totalHeight: "Longitud Total Interna (L_tot)",
    ...
    currentHeight: "Nivel del Líquido",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für LIEGENDE zylindrische Tanks mit Standard- oder kundenspezifischem konischem Boden und gewölbtem Deckel. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    active: "AKTIV",
