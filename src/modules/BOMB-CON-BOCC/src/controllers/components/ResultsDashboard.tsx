                ...
                <div className="space-y-2 mt-3 text-xs text-neutral-800">
                  <div className="flex justify-between py-1 border-b border-neutral-200">
                    <span className="font-bold text-neutral-900">
                      {lang === 'en' ? 'Truncated Cone Bottom Volume:' : lang === 'es' ? 'Volumen del Fondo Troncocónico:' : lang === 'de' ? 'Volumen des Kegelstumpfbodens:' : 'Volume Fondo Troncoconico:'}
                    </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white border-4 border-double border-emerald-800 rounded-xl p-4 shadow-xs">
                ...
                <div className="space-y-1 text-xs font-mono">
                  ...
                  <div className="flex justify-between py-0.5 border-b border-neutral-100">
                    <span className="text-neutral-500">rMin (base minore):</span>
                    <span className="font-bold text-neutral-800">{formatNum(result.fondo.rMin, 2)} mm</span>
                  </div>
                  {result.fondo.hBocc > 0 && (
                    <>
                      <div className="flex justify-between py-0.5 border-b border-neutral-100">
                        <span className="text-neutral-500">rBocc (tronchetto):</span>
                        <span className="font-bold text-neutral-800">{formatNum(result.fondo.rBocc, 2)} mm</span>
                      </div>
                      <div className="flex justify-between py-0.5 border-b border-neutral-100">
                        <span className="text-neutral-500">hBocc (tronchetto):</span>
                        <span className="font-bold text-neutral-800">{formatNum(result.fondo.hBocc, 2)} mm</span>
                      </div>
                      <div className="flex justify-between py-0.5">
                        <span className="text-neutral-500">V Bocchello:</span>
                        <span className="font-bold text-neutral-800">{formatNum(result.fondo.V_bocchello, 3)} l</span>
                      </div>
                    </>
                  )}
                </div>
