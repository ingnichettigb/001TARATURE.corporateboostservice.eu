...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici verticali dotati di fondo troncoconico con bocchello (cono con base minore piana di diametro d_min, più un tronchetto cilindrico di scarico/attacco) e coperchio conico. Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      ...
      sections: [
        {
          ...
          items: [
            "**Zona 7 (Calotta sferica del coperchio)**: Porzione bombata centrale di raggio R del coperchio.",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step calibration for vertical cylindrical tanks with a truncated-cone bottom fitted with a bottom nozzle (a cone with a flat minor base of diameter d_min, plus a cylindrical stub) and a conical top. Calculations are computed continuously with 1 mm step resolution.",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza el cálculo geométrico milimétrico de tanques cilíndricos verticales con fondo troncocónico con boquilla (cono con base menor plana de diámetro d_min, más un tronco cilíndrico) y tapa cónica. La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            "**Zona 7 (Corona central de la tapa)**: Parte abombada de radio R de la tapa.",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Inhaltsberechnung für stehende zylindrische Behälter mit Kegelstumpfboden mit Bodenstutzen (Kegel mit flacher kleiner Grundfläche d_min, plus zylindrischem Stutzen) und konischem Deckel. Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
