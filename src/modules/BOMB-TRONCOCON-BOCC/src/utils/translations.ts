...
export interface TranslationDict {
  ...
  // Bocchello di fondo (BOMB-TRONCOCON-BOCC)
...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "BOMB-TRONCOCON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo troncoconico e coperchio bombato standard o custom. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
  ...
  en: {
    appName: "BOMB-TRONCOCON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with truncated-cone bottom and standard or custom dished top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con fondo troncocónico y tapa bombada estándar o personalizada. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für zylindrische Tanks mit Kegelstumpfboden und Standard- oder kundenspezifischem gewölbtem Deckel. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    active: "AKTIV",
