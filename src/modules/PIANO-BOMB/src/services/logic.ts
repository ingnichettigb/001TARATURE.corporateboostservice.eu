...
/**
 * CUORE LOGICO DEL MODULO PIANO-BOMB (livello 3).
 *
...
export function calculate(values: ModuleValues): ModuleCalcOutput {
  ...
  return {
    summary: [],
    notes: [
      "Cuore logico non ancora implementato: sostituisci core/logic.ts con il codice del modulo.",
    ],
  };
}

export function getPdfFooterNote(): string {
  return "Documento generato dal modulo PIANO-BOMB — Taratura Serbatoi.";
}
