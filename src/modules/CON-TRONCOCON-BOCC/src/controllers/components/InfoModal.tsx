...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici verticali dotati di fondo troncoconico (cono con base minore piana, di diametro d_min) e coperchio conico a punta. Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Il Modello Matematico a 7 Zone",
          desc: "Il serbatoio viene scomposto geometricamente in 7 zone d'integrazione continue per gestire con assoluto rigore matematico la variazione di raggio dovuta alla conicità delle testate e alla raccordatura cono/colletto:",
          items: [
            ...
            "**Zona 7 (Cono del coperchio)**: Porzione conica retta del coperchio, dall'inizio del raccordo fino all'apice.",
            "**Zone 2 & 6 (Raccordi cono/colletto)**: Gestiscono l'arco tangente di raggio r (knuckle radius) che unisce la superficie conica al colletto cilindrico.",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step calibration for vertical cylindrical tanks with a truncated-cone bottom (a cone with a flat minor base of diameter d_min) and a pointed conical top. Calculations are computed continuously with 1 mm step resolution.",
      
      sections: [
        {
          icon: Layers,
          title: "1. The 7-Zone Mathematical Model",
          desc: "The tank volume is dynamically divided into 7 distinct geometric integration zones to strictly solve for the varying radii of the conical heads and their knuckle joints:",
          items: [
            ...
            "**Zone 7 (Top cone)**: Straight conical part of the top head, from the end of the knuckle up to the apex.",
            "**Zones 2 & 6 (Cone/flange knuckle joints)**: Tangent arc transitions with radius r (knuckle radius) joining the conical surface to the straight flange.",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza el cálculo geométrico milimétrico de tanques cilíndricos verticales con fondo troncocónico (cono con base menor plana, de diámetro d_min) y tapa cónica en punta. La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 7 (Cono de la tapa)**: Parte cónica recta de la tapa, desde el final del empalme hasta el vértice.",
            "**Zonas 2 y 6 (Empalme cono/collarín)**: Transición de arco tangente con radio de acuerdo r que une la superficie cónica al collarín cilíndrico.",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Inhaltsberechnung für stehende zylindrische Behälter mit Kegelstumpfboden (Kegel mit ebener kleiner Grundfläche vom Durchmesser d_min) und spitzem konischem Deckel. Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 7 (Kegel des Deckels)**: Gerader Kegelteil des Deckels, vom Ende der Krempe bis zur Spitze.",
            "**Zonen 2 & 6 (Krempenbereich Konus/Bord)**: Tangentialer Übergangsbogen mit Radius r (Krempenradius) zur Verbindung der Kegelfläche mit der zylindrischen Zarge.",
