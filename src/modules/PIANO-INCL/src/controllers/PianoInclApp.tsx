    ...
    return (
      <div className="min-h-dvh bg-[#ebf2ee] text-neutral-900 font-sans antialiased flex items-center justify-center p-6">
        <div className="bg-white border-4 border-double border-emerald-800 rounded-xl p-8 max-w-md w-full text-center space-y-4 shadow-xs">
          <h1 className="text-xl font-black uppercase text-emerald-950">PIANO-INCL TARATURA</h1>
      ...
      <div className="hidden print:block p-4 text-neutral-900 bg-white">
            ...
            <div className="grid grid-cols-12 gap-6 pt-2">
              ...
              <div className="col-span-5 flex flex-col items-center p-3 border border-neutral-300 rounded-xl bg-neutral-50/40">
                ...
                <div className="w-full text-[7.5px] font-mono text-neutral-600 mt-2 space-y-0.5 border-t border-neutral-200 pt-1.5 leading-tight">
                  <div><strong>Zone 1:</strong> {lang === 'en' ? 'Inclined bottom plate (wedge)' : lang === 'es' ? 'Plano inclinado Fondo (cuña)' : lang === 'de' ? 'Schrägboden (Keil)' : 'Piano inclinato Fondo (cuneo)'}</div>
                  <div><strong>Zone 2:</strong> {lang === 'en' ? 'Bottom knuckle (toroidal, active only if r > 0)' : lang === 'es' ? 'Raccordo fondo (toroidal, activo solo si r > 0)' : lang === 'de' ? 'Bodenkrempe (toroidal, nur aktiv bei r > 0)' : 'Raccordo toroidale Fondo (attivo solo se r > 0)'}</div>
                  ...
                  <div><strong>Zone 7:</strong> {lang === 'en' ? 'Flat disc Top' : lang === 'es' ? 'Disco plano Tapa' : lang === 'de' ? 'Flache Scheibe Deckel' : 'Disco piano Coperchio'}</div>
                </div>
              </div>
        ...
        <div className="p-2 space-y-4 bg-white">
          ...
          <div className="pt-4 flex justify-between items-center text-[8px] font-mono text-neutral-400">
            <span>
              {lang === 'en' ? 'Generated via PIANO-INCL TARATURA v1.2' :
               lang === 'es' ? 'Generado mediante PIANO-INCL TARATURA v1.2' :
               lang === 'de' ? 'Generiert über PIANO-INCL TARATURA v1.2' :
               'Generato tramite PIANO-INCL TARATURA v1.2'}
            </span>
            <span>
