...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici verticali dotati di fondo inclinato e coperchio piano, con raccordo toroidale opzionale verso il colletto. Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Il Modello Matematico a 7 Zone",
          desc: "Il serbatoio viene scomposto geometricamente in 7 zone d'integrazione continue, per gestire con rigore matematico sia il piano inclinato del fondo sia l'eventuale raccordo del coperchio piano:",
          items: [
            "**Zona 1 (Fondo inclinato)**: Integra il cuneo generato dal piano inclinato, dal punto basso al punto alto.",
            "**Zona 2 (Transizione inferiore) e Zona 6 (Raccordo superiore)**: Raccordano rispettivamente il fondo al colletto e il coperchio piano al proprio colletto (raccordo toroidale, attivo solo se r > 0).",
            "**Zona 7 (Disco piano superiore)**: Corrisponde al disco piano centrale del coperchio; ha quota nulla quando il raccordo di Zona 6 assorbe già l'intera altezza della testata.",
        ...
        },
        {
          ...
          desc: "Il fondo è definito da dislivello e inclinazione collegati; il coperchio è un disco piano con raccordo opzionale verso il colletto:",
          items: [
            "**Fondo inclinato**: Dislivello Δ = D × tan(α), con aggiornamento automatico nei due sensi.",
            "**Coperchio piano**: Disco piano di raggio X = D/2 - r, con raccordo toroidale di raggio r verso il colletto.",
            "**Raccordo r = 0**: Il coperchio è un disco piano puro, senza arrotondamento verso il colletto.",
            "**Raccordo r > 0**: Introduce un arco a quarto di toro (raggio r) tra il disco piano e il colletto cilindrico, fino a un massimo di r = D/2."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Passo C (Configurazione Geometrica)**: Definire dislivello o inclinazione del fondo, colletto e spessore; configurare separatamente il coperchio piano (raccordo r opzionale verso il colletto).",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step calibration for vertical cylindrical tanks with an inclined bottom and a flat top, with an optional toroidal knuckle toward the flange. Calculations use a continuous 1 mm step resolution.",
      
      sections: [
        {
          icon: Layers,
          title: "1. The 7-Zone Mathematical Model",
          desc: "The tank volume is dynamically divided into 7 distinct geometric integration zones to strictly solve for the varying radii of the heads:",
          items: [
            "**Zone 1 (Inclined bottom)**: Integrates the wedge from the low point to the high point.",
            "**Zone 2 (Lower transition) and Zone 6 (Upper knuckle)**: Join the bottom and flat top to their straight flanges (Zone 6 is a toroidal knuckle, active only when r > 0).",
            "**Zone 7 (Top flat disc)**: Central flat disc of the top head; zero-height when Zone 6's knuckle already spans the full head height.",
        ...
        },
        {
          ...
          desc: "The bottom uses linked slope drop and angle values; the top is a flat disc with an optional knuckle toward the flange:",
          items: [
            "**Inclined bottom**: Drop Δ = D × tan(α), updated automatically in both directions.",
            "**Flat top**: Flat disc of radius X = D/2 - r, with a toroidal knuckle of radius r toward the flange.",
            "**Knuckle r = 0**: The top is a pure flat disc, with no rounding toward the flange.",
            "**Knuckle r > 0**: Introduces a quarter-torus arc (radius r) between the flat disc and the straight flange, up to r = D/2."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Step C (Tank Geometry)**: Enter either bottom drop or slope angle, flange and thickness; configure the flat top separately (optional knuckle radius).",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza la calibración milimétrica de tanques cilíndricos verticales con fondo inclinado y tapa plana, con racor toroidal opcional hacia el collarín. La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 2 (Transición inferior) y Zona 6 (Racor superior)**: Unen el fondo y la tapa plana con sus collarines (Zona 6 es un racor toroidal, activo solo si r > 0).",
            "**Zona 7 (Disco plano superior)**: Disco plano central de la tapa; altura nula cuando el racor de la Zona 6 ya cubre toda la altura de la cabeza.",
        ...
        },
        {
          ...
          desc: "El fondo usa desnivel y ángulo vinculados; la tapa es un disco plano con racor opcional hacia el collarín:",
          items: [
            "**Fondo inclinado**: Desnivel Δ = D × tan(α), actualizado automáticamente en ambos sentidos.",
            "**Tapa plana**: Disco plano de radio X = D/2 - r, con racor toroidal de radio r hacia el collarín.",
            "**Racor r = 0**: La tapa es un disco plano puro, sin redondeo hacia el collarín.",
            "**Racor r > 0**: Introduce un arco de cuarto de toro (radio r) entre el disco plano y el collarín, hasta r = D/2."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Paso C (Geometría del Tanque)**: Introduzca desnivel o ángulo del fondo, collarín y espesor; configure la tapa plana por separado (radio de racor opcional).",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Kalibrierung vertikaler zylindrischer Behälter mit Schrägboden und flachem Deckel, mit optionaler toroidaler Krempe zum Bord hin. Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Das mathematische 7-Zonen-Modell",
          desc: "Das Gesamtvolumen wird zur Integration präzise in 7 Abschnitte unterteilt, um Knickradien und Neigung exakt abzubilden:",
          items: [
            "**Zone 1 (Schrägboden)**: Integriert den Keil vom Tiefpunkt bis zum Hochpunkt.",
            "**Zone 2 (Unterer Übergang) und Zone 6 (Oberer Krempenbereich)**: Verbinden Boden und flachen Deckel mit ihren Borden (Zone 6 ist eine toroidale Krempe, nur aktiv bei r > 0).",
            "**Zone 7 (Obere flache Scheibe)**: Flache Scheibe in der Deckelmitte; Höhe null, wenn die Krempe aus Zone 6 bereits die gesamte Deckelhöhe abdeckt.",
        ...
        },
        {
          ...
          desc: "Der Boden nutzt gekoppelte Werte für Höhenunterschied und Neigung; der Deckel ist eine flache Scheibe mit optionaler Krempe zum Bord hin:",
          items: [
            "**Schrägboden**: Höhenunterschied Δ = D × tan(α), automatische Aktualisierung in beide Richtungen.",
            "**Flacher Deckel**: Flache Scheibe mit Radius X = D/2 - r, mit toroidaler Krempe vom Radius r zum Bord hin.",
            "**Krempe r = 0**: Der Deckel ist eine reine flache Scheibe ohne Rundung zum Bord hin.",
            "**Krempe r > 0**: Fügt einen Viertelkreisbogen (Radius r) zwischen flacher Scheibe und Bord ein, bis maximal r = D/2."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Schritt C (Tank-Geometrie)**: Höhenunterschied oder Neigungswinkel, Bordhöhe und Dicke des Bodens eingeben; den flachen Deckel separat konfigurieren (optionaler Krempenradius).",
