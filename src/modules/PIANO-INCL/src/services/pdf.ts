  ...
  try {
    ...
    const labels: Record<Language, any> = {
      it: {
        ...
        bottomHead: 'Fondo Inclinato:',
        topHead: 'Coperchio Disco Piano:',
    ...
    // Top flat (piano): nessuna calotta da disegnare, il rettangolo copre già il coperchio piano
    ...
    // Top flat outline (coperchio piano)
    ...
    const grpTop = lang === 'en' ? 'flat top' : lang === 'es' ? 'tapa plana sup.' : lang === 'de' ? 'oberer flacher Deckel' : 'coperchio piano';
    ...
    for (let i = 1; i <= totalPagesCount; i++) {
      ...
      doc.text('PIANO-INCL Taratura', 105, 287, { align: 'center' });
