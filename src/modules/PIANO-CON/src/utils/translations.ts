...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "PIANO-CON TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo conico e coperchio piano. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
