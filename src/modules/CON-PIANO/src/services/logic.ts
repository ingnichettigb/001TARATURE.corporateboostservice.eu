 ...
 *
 * CON-PIANO: coperchio CONICO (config.type === 'conico': cono retto + raccordo
 * cono/colletto di raggio rRaccordo + colletto) e fondo PIANO (config.type ===
 * 'piano': disco di lamiera + raccordo toroidale opzionale di raggio r_custom +
 * colletto).
 */
