...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "CON-PIANO TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con coperchio conico e fondo piano con raccordo. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
    ...
    zone7Name: "Cono superiore (Coperchio)",
    zone6Name: "Raccordo cono/colletto (Coperchio)",
    zone5Name: "Colletto cilindrico (Coperchio)",
    zone4Name: "Mantello cilindrico (L_cil)",
    zone3Name: "Colletto cilindrico (Fondo)",
    zone2Name: "Raccordo fondo piano (Fondo)",
    zone1Name: "Fondo piano (h = 0)",
  ...
  en: {
    appName: "CON-PIANO TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with a conical top and a flat bottom with knuckle. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
    ...
    zone7Name: "Top cone (Cover)",
    zone6Name: "Top cone/flange knuckle",
    zone5Name: "Top head straight flange",
    zone4Name: "Cylindrical shell (L_cil)",
    zone3Name: "Bottom head straight flange",
    zone2Name: "Flat bottom knuckle",
    zone1Name: "Flat bottom (h = 0)",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con tapa cónica y fondo plano con racor. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
    ...
    zone7Name: "Cono superior (Tapa)",
    zone6Name: "Racor cono/collarín superior",
    zone5Name: "Cuello cilíndrico superior",
    zone4Name: "Cuerpo cilíndrico (L_cil)",
    zone3Name: "Cuello cilíndrico inferior",
    zone2Name: "Racor fondo plano",
    zone1Name: "Fondo plano (h = 0)",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für zylindrische Tanks mit konischem Deckel und flachem Boden mit Krempe. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    active: "AKTIV",
    ...
    zone7Name: "Oberer Kegel (Deckel)",
    zone6Name: "Obere Verrundung Kegel/Bord",
    zone5Name: "Oberer zylindrischer Bord",
    zone4Name: "Zylindrischer Mantel (L_cil)",
    zone3Name: "Unterer zylindrischer Bord",
    zone2Name: "Krempe Flachboden",
    zone1Name: "Flachboden (h = 0)",
