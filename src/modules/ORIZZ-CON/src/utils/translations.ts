...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "ORIZZ-CON TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici orizzontali con teste coniche, anche inclinati. Livello misurato dal punto più basso, calcolo a segmenti circolari (passo 1 mm)",
    active: "ATTIVO",
    ...
    tabFondo: "Testa sinistra",
    tabCoperchio: "Testa destra",
    tabReport: "Report",
    ...
    lCil: "Lunghezza Parte Cilindrica (L_cil)",
    ...
    equalHeads: "Teste uguali (Testa destra uguale a Testa sinistra)",
    superiorHead: "Testa Destra",
    inferiorHead: "Testa Sinistra",
    ...
    headsCapacity: "Capacità Totale Teste",
    fondoCapacity: "Capacità Testa Sinistra",
    coperchioCapacity: "Capacità Testa Destra",
    totalHeight: "Livello Massimo (H_tot)",
    tiltAngle: "Inclinazione asse (°)",
    percentCol: "% Riempimento",
    stepH: "Passo Rilievo (Frazione Altezza)",
    stepLabel: "Passo 1 mm",
    showStrappingTable: "Mostra Tabella di Taratura Millimetrica",
    interactivePlot: "1. Sagoma Serbatoio Orizzontale",
    realtimeLevel: "Lettura Volume Real-Time",
    currentHeight: "Livello (dal punto più basso)",
    currentVolume: "Volume Contenuto",
    currentPercent: "Percentuale Riempimento",
    zonesTitle: "Sagoma e Livello",
    zonesSub: "Serbatoio orizzontale: sezione a segmento circolare (passo 1 mm)",
  ...
  en: {
    appName: "ORIZZ-CON CALIBRATION",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for horizontal cylindrical tanks with conical heads, including tilted tanks. Level measured from the lowest point, circular-segment calculation (1 mm steps)",
    active: "ACTIVE",
    ...
    equalHeads: "Equal heads (Right Head same as Left Head)",
    superiorHead: "Right Head",
    inferiorHead: "Left Head",
    ...
    fondoCapacity: "Left Head Capacity",
    coperchioCapacity: "Right Head Capacity",
    ...
    interactivePlot: "1. Horizontal Tank Outline",
    realtimeLevel: "Real-Time Volume Calculator",
    currentHeight: "Level (from lowest point)",
    currentVolume: "Contained Volume",
    currentPercent: "Filling Percentage",
    zonesTitle: "Outline and Level",
    zonesSub: "Horizontal tank: circular-segment cross-section (1 mm steps)",
  ...
  es: {
    appName: "ORIZZ-CON AFORO",
    appSub: "v1.2 (COMPATIBLE CON EXCEL 01)",
    appTeaser: "Aforo milimétrico profesional para tanques cilíndricos horizontales con cabezales cónicos, también inclinados. Nivel medido desde el punto más bajo, cálculo por segmentos circulares (paso 1 mm)",
    active: "ACTIVO",
    ...
    tabFondo: "Cabezal izquierdo",
    tabCoperchio: "Cabezal derecho",
    ...
    lCil: "Longitud de la Parte Cilíndrica (L_cil)",
    ...
    equalHeads: "Cabezales iguales (derecho igual al izquierdo)",
    superiorHead: "Cabezal Derecho",
    inferiorHead: "Cabezal Izquierdo",
    ...
    fondoCapacity: "Capacidad Cabezal Izquierdo",
    coperchioCapacity: "Capacidad Cabezal Derecho",
    totalHeight: "Nivel Máximo (H_tot)",
    tiltAngle: "Inclinación del eje (°)",
    percentCol: "% Llenado",
    ...
    interactivePlot: "1. Silueta del Tanque Horizontal",
    realtimeLevel: "Calculador de Volumen en Tiempo Real",
    currentHeight: "Nivel (desde el punto más bajo)",
    currentVolume: "Volumen Contenido",
    currentPercent: "Porcentaje de Llenado",
    zonesTitle: "Silueta y Nivel",
    zonesSub: "Tanque horizontal: sección de segmento circular (paso 1 mm)",
  ...
  de: {
    appName: "ORIZZ-CON PEILUNG",
    appSub: "v1.2 (EXCEL 01 KOMPATIBEL)",
    appTeaser: "Professionelle millimetergenaue Peiltabelle für liegende zylindrische Tanks mit konischen Böden, auch geneigt. Füllstand ab dem tiefsten Punkt, Berechnung über Kreissegmente (1-mm-Schritte)",
    active: "AKTIV",
    ...
    tabFondo: "Linker Boden",
    tabCoperchio: "Rechter Boden",
    ...
    lCil: "Länge des zylindrischen Teils (L_cil)",
    ...
    equalHeads: "Gleiche Böden (rechts gleich links)",
    superiorHead: "Rechter Boden",
    inferiorHead: "Linker Boden",
    ...
    headsCapacity: "Gesamtvolumen der Böden",
    fondoCapacity: "Volumen Linker Boden",
    coperchioCapacity: "Volumen Rechter Boden",
    totalHeight: "Maximaler Füllstand (H_tot)",
    tiltAngle: "Neigung der Achse (°)",
    percentCol: "% Füllung",
    ...
    interactivePlot: "1. Kontur des liegenden Tanks",
    realtimeLevel: "Echtzeit-Volumenrechner",
    currentHeight: "Füllstand (ab tiefstem Punkt)",
    currentVolume: "Inhaltsvolumen",
    currentPercent: "Füllprozentsatz",
    zonesTitle: "Kontur und Füllstand",
    zonesSub: "Liegender Tank: Kreissegment-Querschnitt (1-mm-Schritte)",
    ...
    tableHeightBase: "Basis-Füllstand",
