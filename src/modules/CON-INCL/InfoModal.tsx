...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici verticali dotati di fondo inclinato e coperchio conico. Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Il Modello Matematico a 7 Zone",
          desc: "Il serbatoio viene scomposto geometricamente in 7 zone d'integrazione continue: fondo inclinato in basso, coperchio conico in alto:",
          items: [
            "**Zona 1 (Fondo inclinato)**: Integra il cuneo generato dal piano inclinato, dal punto basso al punto alto.",
            "**Zona 2 (Transizione inferiore) e Zona 6 (Raccordo superiore)**: Raccordano rispettivamente il fondo al colletto e il coperchio conico al proprio colletto.",
            "**Zona 7 (Cono superiore)**: Corrisponde alla porzione conica pura del coperchio, dal raccordo fino all'apice.",
        ...
        },
        {
          ...
          desc: "Il fondo è definito da dislivello e inclinazione collegati; il coperchio è definito da altezza del cono e raccordo cono/colletto, collegati anch'essi in modo bidirezionale:",
          items: [
            "**Fondo inclinato**: Dislivello Δ = D × tan(α), con aggiornamento automatico nei due sensi.",
            "**Coperchio conico**: Altezza h_cono (colletto incluso) e angolo α legati dalla stessa relazione geometrica del raccordo cono/colletto, con aggiornamento automatico nei due sensi.",
            "**Raggio di raccordo (r_raccordo)**: Raccorda la superficie conica al colletto cilindrico, evitando lo spigolo vivo."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Passo C (Configurazione Geometrica)**: Definire dislivello o inclinazione del fondo, colletto e spessore; configurare separatamente altezza e raccordo del coperchio conico.",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step calibration for vertical cylindrical tanks with an inclined bottom and a conical top. Calculations use a continuous 1 mm step resolution.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 2 (Lower transition) and Zone 6 (Upper knuckle)**: Join the bottom and conical top to their straight flanges.",
            "**Zone 7 (Cone)**: Pure conical part of the top head, from the knuckle to the apex.",
        ...
        },
        {
          ...
          desc: "The bottom uses linked slope drop and angle values; the top uses linked cone height and angle values:",
          items: [
            "**Inclined bottom**: Drop Δ = D × tan(α), updated automatically in both directions.",
            "**Conical top**: Total height h_cono (collar included) and angle α linked by the same geometric relation as the cone/collar knuckle, updated automatically in both directions.",
            "**Knuckle radius (r_raccordo)**: Blends the conical surface into the straight collar, avoiding a sharp edge."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Step C (Tank Geometry)**: Enter either bottom drop or slope angle, flange and thickness; configure the conical top height and knuckle radius separately.",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza la calibración milimétrica de tanques cilíndricos verticales con fondo inclinado y tapa cónica. La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 2 (Transición inferior) y Zona 6 (Racor superior)**: Unen el fondo y la tapa cónica con sus collarines.",
            "**Zona 7 (Cono)**: Parte cónica pura de la tapa, desde el racor hasta el vértice.",
        ...
        },
        {
          ...
          desc: "El fondo usa desnivel y ángulo vinculados; la tapa cónica usa altura y ángulo vinculados del mismo modo:",
          items: [
            "**Fondo inclinado**: Desnivel Δ = D × tan(α), actualizado automáticamente en ambos sentidos.",
            "**Tapa cónica**: Altura total h_cono (collarín incluido) y ángulo α vinculados por la misma relación geométrica del racor cono/collarín, actualizados automáticamente en ambos sentidos.",
            "**Radio de racor (r_raccordo)**: Une la superficie cónica al collarín cilíndrico, evitando el canto vivo."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Paso C (Geometría del Tanque)**: Introduzca desnivel o ángulo del fondo, collarín y espesor; configure la altura y el racor de la tapa cónica por separado.",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Kalibrierung vertikaler zylindrischer Behälter mit Schrägboden und konischem Deckel. Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 2 (Unterer Übergang) und Zone 6 (Oberer Krempenbereich)**: Verbinden Boden und konischen Deckel mit ihren Borden.",
            "**Zone 7 (Konus)**: Rein konischer Teil des Deckels, von der Krempe bis zur Spitze.",
        ...
        },
        {
          ...
          desc: "Der Boden nutzt gekoppelte Werte für Höhenunterschied und Neigung; der konische Deckel nutzt ebenso gekoppelte Werte für Höhe und Winkel:",
          items: [
            "**Schrägboden**: Höhenunterschied Δ = D × tan(α), automatische Aktualisierung in beide Richtungen.",
            "**Konischer Deckel**: Gesamthöhe h_cono (inkl. Kragen) und Winkel α, verknüpft über dieselbe geometrische Beziehung der Konus/Kragen-Verrundung, automatische Aktualisierung in beide Richtungen.",
            "**Verrundungsradius (r_raccordo)**: Verbindet die konische Fläche mit dem zylindrischen Kragen ohne scharfe Kante."
          ]
        },
        {
          icon: Settings,
          ...
          items: [
            ...
            "**Schritt C (Tank-Geometrie)**: Höhenunterschied oder Neigungswinkel, Bordhöhe und Dicke des Bodens eingeben; Höhe und Verrundungsradius des konischen Deckels separat konfigurieren.",
