...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "CON-INCL TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo inclinato e coperchio conico standard o custom. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
  ...
  en: {
    appName: "CON-INCL TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with an inclined bottom and a standard or custom conical top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con fondo inclinado y tapa cónica estándar o personalizada. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für zylindrische Tanks mit Schrägboden und konischem Standard- oder kundenspezifischem Deckel. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    active: "AKTIV",
