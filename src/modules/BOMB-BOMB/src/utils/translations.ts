...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "BOMB-BOMB TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo bombato e coperchio bombato standard o custom. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    active: "ATTIVO",
  ...
  en: {
    appName: "BOMB-BOMB TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with standard or custom dished bottom and dished top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    active: "ACTIVE",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con fondo bombeado estándar o personalizado y tapa bombada. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    active: "ACTIVO",
