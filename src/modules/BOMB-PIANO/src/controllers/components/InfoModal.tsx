...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
    it: {
      ...
      intro: "Questo applicativo professionale esegue la taratura geometrica millimetrica di serbatoi cilindrici dotati di coperchio bombato standard (Klöpper, Korbbogen), pseudoellittico o completamente personalizzato, e di fondo piano (disco di lamiera con raccordo toroidale opzionale). Il calcolo volumetrico si basa su una discretizzazione continua a passo di 1 millimetro.",
      
      sections: [
        {
          icon: Layers,
          title: "1. Il Modello Matematico a 7 Zone",
          desc: "Il serbatoio viene scomposto geometricamente in 7 zone d'integrazione continue per gestire con assoluto rigore matematico la variazione di raggio dovuta alla raccordatura e alla bombatura del coperchio:",
          items: [
            ...
            "**Zona 7 (Calotta sferica del coperchio)**: Corrisponde alla porzione bombata centrale di raggio R del coperchio.",
            "**Zona 6 (Raccordo torisferico del coperchio)**: Gestisce la curvatura di raccordo r (knuckle radius) che unisce la calotta centrale al colletto cilindrico.",
        ...
        },
        {
          ...
          desc: "Il coperchio può essere selezionato tra diverse tipologie di testata bombata; il fondo è sempre piano:",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Passo C (Configurazione Testate)**: Per il coperchio bombato scegliere la tipologia (Klöpper, Korbbogen, Pseudoellittico o Fuori Standard), lo spessore e l'altezza del colletto. Per il fondo piano indicare raggio di raccordo r (0 = nessuno, massimo D/2), altezza del colletto (anche 0) e spessore lamiera.",
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step strapping and calibration for cylindrical tanks equipped with a dished top head (standard Klöpper, Korbbogen, pseudo-elliptical or fully custom torispherical) and a flat bottom plate (with an optional toroidal knuckle). Calculations are computed continuously with 1 mm step resolution.",
      
      sections: [
        {
          icon: Layers,
          title: "1. The 7-Zone Mathematical Model",
          desc: "The tank volume is dynamically divided into 7 distinct geometric integration zones to strictly solve for the varying radius of the dished top head:",
          items: [
            ...
            "**Zone 7 (Top spherical crown)**: Central dished part with radius R of the top head.",
            "**Zone 6 (Top torispherical knuckle)**: Curved transition with radius r (knuckle radius) joining the central crown to the straight flange.",
        ...
        },
        {
          ...
          desc: "The top head can be chosen from the following dished types; the bottom is always flat:",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Step C (Heads)**: For the dished top head choose the type (Klöpper, Korbbogen, Pseudo-elliptical or Custom), plate thickness and straight flange height. For the flat bottom set knuckle radius r (0 = none, max D/2), flange height (can be 0) and plate thickness.",
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza el cálculo geométrico milimétrico de tanques cilíndricos equipados con tapa abombada (Klöpper, Korbbogen estándar, pseudoelíptica o personalizada) y fondo plano (con racor toroidal opcional). La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 7 (Corona central de la tapa)**: Parte abombada de radio de abombamiento R.",
            "**Zona 6 (Racor torisférico de la tapa)**: Transición curva con radio de acuerdo r.",
        ...
        },
        {
          ...
          desc: "La tapa admite las siguientes normativas de cabezal abombado; el fondo es siempre plano:",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Paso C (Configuración de Cabezales)**: Para la tapa abombada elija el tipo (Klöpper, Korbbogen, Pseudoellittico o Custom), el espesor y la altura del cuello. Para el fondo plano indique radio de racor r (0 = ninguno, máx. D/2), altura del collarín (puede ser 0) y espesor.",
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Inhaltsberechnung (Peiltabellen) für zylindrische Behälter mit gewölbtem Deckel (Standard Klöpper, Korbbogen, pseudo-elliptisch oder kundenspezifisch) und flachem Boden (mit optionaler Krempe). Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 7 (Zentraler Kugelbereich des Deckels)**: Gewölbter Hauptteil mit Radius R des Deckels.",
            "**Zone 6 (Krempenbereich des Deckels)**: Übergangsradius r (Krempenradius) zur Verbindung mit dem zylindrischen Bord.",
        ...
        },
        {
          ...
          desc: "Für den Deckel stehen folgende gewölbte Geometrien zur Auswahl; der Boden ist immer flach:",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Schritt C (Böden)**: Für den gewölbten Deckel Typ (Klöpper, Korbbogen, Pseudoellittico oder Custom), Wandstärke und Bordhöhe wählen. Für den Flachboden Krempenradius r (0 = keine, max. D/2), Bordhöhe (auch 0) und Blechdicke eingeben.",
