...
export interface TranslationDict {
  ...
  appSub: string;
  appTeaser: string;
  // Bocchello di fondo (PIANO-CON-BOCC)
...
export const translations: Record<Language, TranslationDict> = {
  it: {
    appName: "PIANO-CON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Taratura millimetrica professionale per serbatoi cilindrici con fondo conico dotato di bocchello (tronco di cono) e coperchio piano. Modello matematico integrato a 7 zone continue (passo 1 mm)",
    bocchelloTitle: "Bocchello di fondo",
    bocchelloHint: "Tronchetto cilindrico applicato sotto il fondo conico: il suo diametro tronca la punta del cono, trasformandolo in un tronco di cono (Ø e altezza). Lascia Ø = 0 per un fondo a cono a punta, senza bocchello.",
    ...
    zone7Name: "Coperchio piano (disco)",
    zone6Name: "Non utilizzata (coperchio piano)",
  ...
  en: {
    appName: "PIANO-CON-BOCC TARATURA",
    appSub: "v1.2 (EXCEL 01 COMPATIBLE)",
    appTeaser: "Professional millimeter-by-millimeter calibration for cylindrical tanks with a nozzle-fitted conic bottom (truncated cone) and flat top. Integrated mathematical model with 7 continuous zones (1 mm steps)",
    bocchelloTitle: "Bottom nozzle (bocchello)",
    bocchelloHint: "Cylindrical stub fitted below the conic bottom: its diameter truncates the cone's tip, turning it into a truncated cone (Ø and height). Leave Ø = 0 for a plain pointed cone with no nozzle.",
  ...
  es: {
    ...
    appTeaser: "Calibración milimétrica profesional para tanques cilíndricos con fondo cónico con boquilla (tronco de cono) y tapa plana. Modelo matemático integrado de 7 zonas continuas (pasos de 1 mm)",
    bocchelloTitle: "Boquilla de fondo",
    bocchelloHint: "Tronco cilíndrico instalado debajo del fondo cónico: su diámetro trunca la punta del cono, convirtiéndolo en un tronco de cono (Ø y altura). Deja Ø = 0 para un fondo cónico puntiagudo, sin boquilla.",
  ...
  de: {
    ...
    appTeaser: "Professionelle millimetergenaue Kalibrierung für zylindrische Tanks mit konischem Boden mit Stutzen (Kegelstumpf) und flachem Deckel. Integriertes mathematisches 7-Zonen-Modell (1 mm Schritte)",
    bocchelloTitle: "Bodenstutzen",
    bocchelloHint: "Zylindrischer Stutzen unterhalb des konischen Bodens: sein Durchmesser kappt die Kegelspitze und macht daraus einen Kegelstumpf (Ø und Höhe). Ø = 0 lassen für einen spitzen Kegel ohne Stutzen.",
