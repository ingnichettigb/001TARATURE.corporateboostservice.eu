          ...
          <div className="flex w-full px-3 gap-3.5 items-center">
            ...
            <svg viewBox="0 0 320 400" className="w-full max-w-[245px] h-[360px] select-none shrink-0">
              ...
              {[
                ...
                { label: lang === 'en' ? 'Z6/Z7 (Top plate)' : lang === 'es' ? 'Z6/Z7 (Tapa sup.)' : lang === 'de' ? 'Z6/Z7 (Oberer Flachdeckel)' : 'Z6/Z7 (Coperchio c.)', val: result.z6 },
              ].map((zone, idx) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border-4 border-double border-emerald-800 rounded-xl p-4 shadow-xs">
                ...
                <div className="space-y-2 mt-3 text-xs text-neutral-800">
                  ...
                  <div className="flex justify-between py-1 border-b border-neutral-200">
                    <span className="font-bold text-neutral-900">
                      {lang === 'en' ? 'Top Head Volume:' : lang === 'es' ? 'Volumen del Extremo Superior:' : lang === 'de' ? 'Volumen des oberen Deckels:' : 'Volume Coperchio Piano:'}
                    </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-neutral-800">
                <div className="space-y-2">
                  <span className="font-black text-neutral-950 border-b-2 border-emerald-900/10 pb-1 block">
                    {lang === 'en' ? 'Bottom Head:' : lang === 'es' ? 'Extremo Inferior:' : lang === 'de' ? 'Unterer Boden:' : 'Fondo Conico:'}
                  </span>
                  ...
                  {(result.input.dBocchello ?? 0) > 0 && (
                    <>
                      <div className="flex justify-between py-1">
                        <span className="font-medium text-neutral-700">
                          {lang === 'en' ? 'Nozzle (Ø × H):' : lang === 'es' ? 'Boquilla (Ø × H):' : lang === 'de' ? 'Stutzen (Ø × H):' : 'Bocchello (Ø × H):'}
                        </span>
                        <span className="font-mono font-bold text-neutral-950">
                          {result.input.dBocchello} × {result.input.hBocchello} mm
                        </span>
                      </div>
                      <div className="flex justify-between py-1">
                        <span className="font-medium text-neutral-700">
                          {lang === 'en' ? 'Nozzle Volume:' : lang === 'es' ? 'Volumen de la Boquilla:' : lang === 'de' ? 'Stutzenvolumen:' : 'Volume Bocchello:'}
                        </span>
                        <span className="font-mono font-bold text-neutral-950">{formatNum(result.volumeBocchello, 2)} L</span>
                      </div>
                    </>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white border-4 border-double border-emerald-800 rounded-xl p-4 shadow-xs">
                ...
                <div className="space-y-1 text-xs font-mono">
                  ...
                  <div className="flex justify-between py-0.5 border-b border-neutral-100">
                    <span className="text-neutral-500">H2 (racc. cono/colletto):</span>
                    <span className="font-bold text-neutral-800">{formatNum(result.fondo.H2, 2)} mm</span>
                  </div>
                  <div className="flex justify-between py-0.5 border-b border-neutral-100">
                    <span className="text-neutral-500">H3 (cono):</span>
              ...
              <div className="bg-white border-4 border-double border-emerald-800 rounded-xl p-4 shadow-xs">
                ...
                <div className="space-y-1 text-xs font-mono">
                  ...
                  <div className="flex justify-between py-0.5 border-b border-neutral-100">
                    <span className="text-neutral-500">H3 (disco):</span>
