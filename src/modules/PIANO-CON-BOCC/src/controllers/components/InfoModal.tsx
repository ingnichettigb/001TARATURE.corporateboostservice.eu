...
export default function InfoModal({ isOpen, onClose, lang }: InfoModalProps) {
  ...
  const content = {
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 0 (Bocchello di fondo)**: presente solo se Ø bocchello > 0. È il tronchetto cilindrico sotto la punta del fondo, e il suo diametro è ciò che tronca il cono trasformandolo in un tronco di cono: il fondo conico (Zona 1) parte quindi da un raggio minimo pari a Ø bocchello / 2 invece che da zero."
          ]
        },
        {
          icon: Cylinder,
    ...
    en: {
      ...
      intro: "This professional application performs high-precision millimeter-step strapping and calibration for horizontal cylindrical tanks equipped with a conic bottom fitted with a drain nozzle (truncated cone) and a flat top plate. Calculations are computed continuously with 1 mm step resolution.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 0 (Bottom Nozzle)**: present only if Nozzle Ø > 0. It's the cylindrical stub beneath the bottom tip; its diameter is what truncates the cone into a frustum, so the conic bottom (Zone 1) starts from a minimum radius of Nozzle Ø / 2 instead of zero."
          ]
        },
        {
          icon: Cylinder,
    ...
    es: {
      ...
      intro: "Esta herramienta profesional realiza el cálculo geométrico milimétrico de tanques cilíndricos horizontales equipados con fondo cónico con boquilla de descarga (tronco de cono) y tapa plana (disco de chapa). La resolución de cálculo es continua de 1 mm.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zona 0 (Boquilla de Fondo)**: presente solo si Ø boquilla > 0. Es el tronco cilíndrico bajo la punta del fondo; su diámetro es lo que trunca el cono convirtiéndolo en un tronco de cono, así el fondo cónico (Zona 1) parte de un radio mínimo igual a Ø boquilla / 2 en vez de cero."
          ]
        },
        {
          icon: Cylinder,
    ...
    de: {
      ...
      intro: "Diese Software dient zur millimetergenauen Inhaltsberechnung (Peiltabellen) für liegende zylindrische Behälter mit konischem Boden mit Ablassstutzen (Kegelstumpf) und flachem Deckel. Der Berechnungsschritt beträgt kontinuierlich 1 Millimeter.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "**Zone 0 (Bodenstutzen)**: nur vorhanden, wenn Stutzen-Ø > 0. Es ist der zylindrische Stutzen unterhalb der Bodenspitze; sein Durchmesser kappt die Kegelspitze zu einem Kegelstumpf, sodass der Konusboden (Zone 1) statt bei null bei einem Mindestradius von Stutzen-Ø / 2 beginnt."
          ]
        },
        {
          icon: Cylinder,
